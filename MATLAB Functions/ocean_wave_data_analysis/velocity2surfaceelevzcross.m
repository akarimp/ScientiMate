function [Eta, t] = velocity2surfaceelevzcross(Ux, Uy, fs, h, heightfrombed, Kuvmin, kCalcMethod, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
.. code:: MATLAB
    ...
    [Eta, t] = velocity2surfaceelevzcross(Ux, Uy, fs, h, heightfrombed, Kuvmin, kCalcMethod, dispout)
...
.. code:: MATLAB
    ...
    Uy=0.2.*Ux;
    [Eta,t]=velocity2surfaceelevzcross(Ux,Uy,fs,5,4,0.15,'beji','yes');
