function [Kp, f] = pressureresponse(f, h, heightfrombed, kCalcMethod, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
.. code:: MATLAB
    ...
    [Kp, f] = pressureresponse(f, h, heightfrombed, kCalcMethod, dispout)
...
.. code:: MATLAB
    ...
    [Kp,f]=pressureresponse(0.2,1,0.2,'beji','no');

    [Kp,f]=pressureresponse([0.2;0.25],[0.5;0.6],0.2,'exact','yes');
...
w=2.*pi.*f; %Wave angular frequency, w=2.pi.f
...
%--------------------------------------------------------------------------
%Calculating a pressure response factor
...
if strcmp(dispout,'yes')==1
    plot(f(f~=0),Kp(f~=0))
    title('Pressure Response vs Frequency')
    xlabel('Frequency (Hz)')
    ylabel('Pressure Response, Kp')
end
