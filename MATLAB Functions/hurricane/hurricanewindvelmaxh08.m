function [Vmax, Vgmax] = hurricanewindvelmaxh08(y, Pc, dPcdt, Vt, Pn, SST, VgToVCoeff, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
switch nargin
    case 4
        Pn=101325; SST=28; VgToVCoeff=0.8; dispout='no';
    case 5
        SST=28; VgToVCoeff=0.8; dispout='no';
    case 6
        VgToVCoeff=0.8; dispout='no';
    case 7
        dispout='no';
end
...
bs=-4.4e-5.*deltaPshPa.^2+0.01.*deltaPshPa+0.03.*dPcdt-0.014.*abs(y)+0.15.*Vt.^xs+1; %Hurricane shape parameter at surface

Vmax=(bs.*deltaP./(Rhoas.*exp(1))).^0.5; %Hurricane maximum wind velocity at surface level (10m above surface)
