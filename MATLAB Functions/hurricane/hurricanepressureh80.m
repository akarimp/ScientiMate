function [Pgrid, Rgrid, RVmax, thetagrid] = hurricanepressureh80(xgrid, ygrid, xCenter, yCenter, Pc, Vgmax, Rknown, VgRknown, Pn, Rhoa,...
...
switch nargin
    case 8
        Pn=101325; Rhoa=1.204; distCalcMethod='gc'; flattendata='no'; savedata='no'; dispout='no';
    case 9
        Rhoa=1.204; distCalcMethod='gc'; flattendata='no'; savedata='no'; dispout='no';
    case 10
...
%f=2.*w.*sin(deg2rad(ygrid)); %Coriolis parameter (Coriolis frequency)
