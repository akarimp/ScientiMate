function [Vmax, Vgmax] = hurricanewindvelmax(Pc, CalcMethod, VgToVCoeff, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
switch nargin
    case 1
        CalcMethod='atkinson'; VgToVCoeff=0.8; dispout='no';
    case 2
...
if strcmp(CalcMethod,'atkinson')==1
...
elseif strcmp(CalcMethod,'dvorak')==1
