function [Vmax, Vgmax] = hurricanewindvelmaxh80(Pc, Pn, Rhoa, VgToVCoeff, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
switch nargin
    case 1
        Pn=101325; Rhoa=1.204; VgToVCoeff=0.8; dispout='no';
    case 2
        Rhoa=1.204; VgToVCoeff=0.8; dispout='no';
    case 3
...
Vgmax=(B.*deltaP./(Rhoa*exp(1))).^0.5; %hurricane maximum 1-min sustained wind velocity at the gradient level in (m/s)
