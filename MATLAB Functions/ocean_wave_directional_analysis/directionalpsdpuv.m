function [Syy2d, f2d, theta] = directionalpsdpuv(P, Ux, Uy, fs, h, Pheightfrombed, UVheightfrombed, dtheta, coordinatesys, fmaxpcorr, fminpcorr, fKuvmin, fcL, fcH, fmaxpcorrCalcMethod, Kpafterfmaxpcorr, KuvafterfKuvmin, kCalcMethod, Rho, nfft, SegmentSize, OverlapSize, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
switch nargin
    case 5
        Pheightfrombed=0; UVheightfrombed=0; dtheta=15; coordinatesys='xyz'; fmaxpcorr=fs/2; fminpcorr=0; fKuvmin=fs/2; fcL=0; fcH=fs/2; fmaxpcorrCalcMethod='auto'; Kpafterfmaxpcorr='constant'; KuvafterfKuvmin='constant'; kCalcMethod='beji'; Rho=1000; nfft=length(P); SegmentSize=256; OverlapSize=128; dispout='no';
    case 6
        UVheightfrombed=0; dtheta=15; coordinatesys='xyz'; fmaxpcorr=fs/2; fminpcorr=0; fKuvmin=fs/2; fcL=0; fcH=fs/2; fmaxpcorrCalcMethod='auto'; Kpafterfmaxpcorr='constant'; KuvafterfKuvmin='constant'; kCalcMethod='beji'; Rho=1000; nfft=length(P); SegmentSize=256; OverlapSize=128; dispout='no';
    case 7
        dtheta=15; coordinatesys='xyz'; fmaxpcorr=fs/2; fminpcorr=0; fKuvmin=fs/2; fcL=0; fcH=fs/2; fmaxpcorrCalcMethod='auto'; Kpafterfmaxpcorr='constant'; KuvafterfKuvmin='constant'; kCalcMethod='beji'; Rho=1000; nfft=length(P); SegmentSize=256; OverlapSize=128; dispout='no';
    case 8
...
%--------------------------------------------------------------------------
%Converting mathematical angle direction to compass direction respect with true north
