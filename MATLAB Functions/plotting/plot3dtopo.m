function [xgrid, ygrid, zgrid, cmap_ncolor] = plot3dtopo(x, y, z, ...
...
switch nargin
    case 3
        ...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 4
        ncolor=256; waterlandcmapratio='none';,...
        plotfontsize=12; axisfontsize=12; xaxislabel='x'; yaxislabel='y'; cbarlabel='z'; dispcolorbar='no'; dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 5
        waterlandcmapratio='none';,...
    ...
    case 6
        ...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 7
        axisfontsize=12; xaxislabel='x'; yaxislabel='y'; cbarlabel='z'; dispcolorbar='no'; dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 8
        xaxislabel='x'; yaxislabel='y'; cbarlabel='z'; dispcolorbar='no'; dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 9
        yaxislabel='y'; cbarlabel='z'; dispcolorbar='no'; dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 10
        cbarlabel='z'; dispcolorbar='no'; dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 11
        dispcolorbar='no'; dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 12
        dispgrid='no';,...
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 13
        gridsize=100; gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 14
        gridsizetype='points'; xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 15
        xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 16
        xmin=nanmin(x(:)); xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 17
        xmax=nanmax(x(:)); ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 18
        ymin=nanmin(y(:)); ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 19
        ymax=nanmax(y(:)); zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 20
        zmin=nanmin(z(:)); zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 21
        zmax=nanmax(z(:)); RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 22
        RetainRatio='all'; interpMethod='nearest'; dispout='imagesc';
    case 23
        interpMethod='nearest'; dispout='imagesc';
    case 24
        dispout='imagesc';
end
...
if (strcmp(dispout,'imagesc')==1 | strcmp(dispout,'pcolor')==1 | strcmp(dispout,'contour')==1 | strcmp(dispout,'surface')==1)
