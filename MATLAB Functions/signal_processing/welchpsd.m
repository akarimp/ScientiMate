function [f, Sxx] = welchpsd(x, fs, SegmentSize, OverlapSize, WindowName, nfft, OutputSmoothSize, dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + ScientiMate                                                            +
...
switch nargin
    case 1
        fs=2; SegmentSize=256; OverlapSize=0; WindowName='hamming'; nfft=265; OutputSmoothSize=0; dispout='no';
    case 2
        SegmentSize=256; OverlapSize=0; WindowName='hamming'; nfft=265; OutputSmoothSize=0; dispout='no';
    case 3
        OverlapSize=0; WindowName='hamming'; nfft=265; OutputSmoothSize=0; dispout='no';
    case 4
