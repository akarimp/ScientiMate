def wavepower(h, H, T, Rho=1000, kCalcMethod='beji'):
    """
    .. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
    .. +                                                                        +
    .. + ScientiMate                                                            +
    ...
    Pw=Cg*E #Wave power
    Sxx=E*((2*k*h)/np.sinh(2*k*h)+1/2) #Wave radiation stress in x direction
    Syy=E*((k*h)/np.sinh(2*k*h)) #Wave radiation stress in y direction
