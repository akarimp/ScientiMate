def pressureresponse(f, h, heightfrombed, kCalcMethod='beji', dispout='no'):
    """
    .. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
    .. +                                                                        +
    .. + ScientiMate                                                            +
    ...
    w=2*np.pi*f #Wave angular frequency, w=2.pi.f
    ...
    if dispout=='yes':
        plt.plot(f[f!=0],Kp[f!=0])
        plt.title('Pressure Response vs Frequency')
        plt.xlabel('Frequency (Hz)')
        plt.ylabel('Pressure Response, Kp')
